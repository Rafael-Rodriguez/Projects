...
namespace Chapter20.CustomerMaintenance.Test.Presentation.Views
{
    ...
    {
        private ModifyCustomerController _addCustomerController;
        ...
        public void Initialize()
        {
            ...
            _addCustomerController = new ModifyCustomerController(_mockedModuleController.Object, _mockedDialogService.Object);

            _view = new ModifyCustomerForm(_addCustomerController);
        }
